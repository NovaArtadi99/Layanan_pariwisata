...
@section('content')
    ...
    <div class="breadcrumbs d-flex align-items-center"
        style="background-image: url('/assets/template_user/assets/img/blog/blog.jpg');">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 ftco-animate py-md-5 mt-md-5">
                    ...
                    <p>
                        <img src="/assets/template_support/blog/images/bg_5.jpg" alt="" class="img-fluid">
                    </p>
                    ...
                    <p>
                        <img src="/assets/template_support/blog/images/bg_1.jpg" alt="" class="img-fluid">
                    </p>
                    ...
                    <div class="about-author d-flex p-4 bg-light">
                        <div class="bio mr-5">
                            <img src="/assets/template_support/blog/images/person_1.jpg" alt="Image placeholder"
                        ...
                        <ul class="comment-list">
                            ...
                            <li class="comment">
                                ...
                                <ul class="children">
                                    <li class="comment">
                                        <div class="vcard bio">
                                            <img src="/assets/template_support/blog/images/person_1.jpg"
                    ...
                    <div class="sidebar-box ftco-animate">
                        ...
                        <div class="block-21 mb-4 d-flex">
                            <a class="blog-img mr-4"
                                style="background-image: url(/assets/template_support/blog/images/image_1.jpg);"></a>
                            <div class="text">
                                <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control
                                        about the blind texts</a></h3>
                                <div class="meta">
                                    <div><a href="#"><span class="fa fa-calendar"></span> September 11, 2020</a>
                                    </div>
                        ...
                        <div class="block-21 mb-4 d-flex">
                            <a class="blog-img mr-4"
                                style="background-image: url(/assets/template_support/blog/images/image_2.jpg);"></a>
                            <div class="text">
                                <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control
                                        about the blind texts</a></h3>
                                <div class="meta">
                        ...
                        <div class="block-21 mb-4 d-flex">
                            <a class="blog-img mr-4"
                                style="background-image: url(/assets/template_support/blog/images/image_3.jpg);"></a>
                            <div class="text">
                                <h3 class="heading"><a href="#">Even the all-powerful Pointing has no control
                                        about the blind texts</a></h3>
                                <div class="meta">
