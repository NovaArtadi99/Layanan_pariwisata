...
<head>
    ...
    <meta name="keywords"
        content="Client Responsive web template, Bootstrap Web Templates, Flat Web Templates, Android Compatible web template,
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />

    <!-- css files -->
    <link href="/assets/template_user2/css/bootstrap.css" rel='stylesheet' type='text/css' /><!-- bootstrap css -->
    <link href="/assets/template_user2/css/style.css" rel='stylesheet' type='text/css' /><!-- custom css -->
    <link href="/assets/template_user2/css/css_slider.css" type="text/css" rel="stylesheet" media="all">
    <link href="/assets/template_user2/css/font-awesome.min.css" rel="stylesheet"><!-- fontawesome css -->
    <!-- //css files -->
...
<body>
                                ...
                                <li>
                                    <div class="container-fluid">
                                        <div class="w3ls_banner_txt">
                                            ...
                                            <p><span class="fa fa-usd" aria-hidden="true"></span>1000
                                            <p>
                                        </div>
                                    </div>
                                </li>
                                <li>
                                    <div class="container-fluid">
                                        <div class="w3ls_banner_txt">
                                            ...
                                            <h4><span class="fa fa-ils" aria-hidden="true"></span>from </h4>
                                            <p><span class="fa fa-usd" aria-hidden="true"></span>1200
                                            <p>
                                ...
                                <li>
                                    <div class="container-fluid">
                                        <div class="w3ls_banner_txt">
                                            ...
                                            <h4><span class="fa fa-ils" aria-hidden="true"></span>from </h4>
                                            <p><span class="fa fa-usd" aria-hidden="true"></span>1400
                                            <p>
                                        </div>
                                    </div>
                                </li>
                            ...
                            <div class="padding">
                                <form action="#" method="post">
                                    ...
                                    <div class="form-style-w3layout">
                                        <input placeholder="Search Location" name="name" type="text"
                                            required="">
                                        <input placeholder="Price Range" name="name" type="text"
                                            required="">
        ...
        <div class="container py-md-5">
            ...
            <div class="row service-grid-grids text-center">
                ...
                <div class="col-lg-4 col-md-6 service-grid service-grid2 mb-4">
                    ...
                    <h4 class="mt-3">Tourist guide</h4>
                    <p class="mt-3">Perspiciatis unde omnis iste natus doloret ipsum volupte ut accusal ntium dolor
                        remque laudantium, totam dolor.</p>
                </div>
                ...
                <div class="col-lg-4 col-md-6 service-grid service-grid3 mb-4">
                    ...
                    <h4 class="mt-3">Flight tickets</h4>
                    <p class="mt-3">Perspiciatis unde omnis iste natus doloret ipsum volupte ut accusal ntium dolor
                        remque laudantium, totam dolor.</p>
                </div>
            </div>
    ...
    <section class="team py-5" id="team">
        <div class="container py-md-5">
            <h3 class="heading text-center mb-3 mb-sm-5">Our Guides</h3>
            <div class="row">
                ...
                <div class="team-grid col-lg-3 col-sm-6  mb-5">
                    <img src="images/t4.jpg" class="" alt="" />
                    <div class="team-info text-center">
            ...
            <div class="header mb-3 mb-sm-5 text-center">
                ...
                <div class="row news-grids text-center">
                    <div class="col-md-4 gal-img">
                        <a href="#gal1"><img src="images/g1.jpg" alt="news image" class="img-fluid"><span>
                                HoneyMoon</span></a>
                        <a href="#gal2"><img src="images/g2.jpg" alt="news image"
                                class="img-fluid"><span>Family</span></a>

                    </div>

                    <div class="col-md-4 gal-img">
                        <a href="#gal3"><img src="images/g3.jpg" alt="news image"
                                class="img-fluid"><span>Holidays</span></a>

                        <a href="#gal4"><img src="images/g4.jpg" alt="news image"
                                class="img-fluid"><span>Adventure</span></a>
                    </div>
                    <div class="col-md-4 gal-img">
                        <a href="#gal5"><img src="images/g5.jpg" alt="news image"
                                class="img-fluid"><span>Luxury</span></a>
                        <a href="#gal6"><img src="images/g6.jpg" alt="news image"
                                class="img-fluid"><span>Romantic</span></a>
                    </div>
                </div>
            </div>
            <!-- popup-->
            ...
            <div class="row footer-top-inner-vv">
                ...
                <div class="col-lg-3 col-sm-6 mt-lg-0 mt-4">
                    <div class="footer-lavi">
                        ...
                        <ul class="list-info-lavi">
                            <li>
                                <a href="index.html"><span class="fa fa-angle-double-right"
    ...
    <div class="copy-right-top">
        <p class="copy-right text-center pt-2">&copy; 2019 Trip Spot. All Rights Reserved | Design by
            <a href="http://w3layouts.com/"> W3layouts </a>
        </p>
    </div>

    <div class="copy-right-top">
        <p class="copy-right text-center py-2">Distributed by
