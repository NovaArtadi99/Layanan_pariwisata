          ...
          <div class="row">
            <div class="col-lg-8">
              <div class="main-image">
                <img src="/assets/template_user/assets/img/penginapan/single-property.jpg" alt="">
              </div>
                  ...
                  <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="appartment" role="tabpanel" aria-labelledby="appartment-tab">
                      <div class="row">
                        ...
                        <div class="col-lg-6">
                          <img src="/assets/template_user/assets/img/penginapan/deal-01.jpg" alt="">
                        </div>
                        <div class="col-lg-3">
                    ...
                    <div class="tab-pane fade" id="villa" role="tabpanel" aria-labelledby="villa-tab">
                      <div class="row">
                        ...
                        <div class="col-lg-6">
                          <img src="/assets/template_user/assets/img/penginapan/deal-02.jpg" alt="">
                        </div>
                        <div class="col-lg-3">
                    ...
                    <div class="tab-pane fade" id="penthouse" role="tabpanel" aria-labelledby="penthouse-tab">
                      <div class="row">
                        ...
                        <div class="col-lg-6">
                          <img src="/assets/template_user/assets/img/penginapan/deal-03.jpg" alt="">
                        </div>
                        <div class="col-lg-3">
